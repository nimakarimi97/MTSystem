...
<template>
  <nav flex="~ col gap-4" mt-6 justify-center py-12 pb-20>
    <div class="footer-top" flex="~ gap-4" justify-center text-xl>
      <RouterLink
        icon-btn to="/" :title="t('button.home')"
